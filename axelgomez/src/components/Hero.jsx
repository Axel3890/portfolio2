          ...
          <div class="flex flex-1 flex-col items-start gap-12 px-3 pb-6 md:pb-12 lg:px-24 lg:pb-0">
              ...
              <div class="flex gap-4">
                  <button type="button"
                      ...
                      <a href="/cv/curriculum.pdf" download="Full Stack - Axel Gomez.pdf"><span className='text-custom-ligthblue'>Descargar CV</span></a>
                  </button>
                  <button type="button"
                      ...
                      <a href='#experiencias'><span className='text-custom-green'>Ver experiencia</span></a>
