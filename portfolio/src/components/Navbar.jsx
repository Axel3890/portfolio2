    ...
    return (
        <nav className="bg-black border-gray-200">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className={`${isMenuOpen ? 'block' : 'hidden'} w-full md:w-auto md:block md:flex md:items-center`} id="navbar-default">
                    <ul className="font-medium flex flex-col md:flex-row md:space-x-8 rtl:space-x-reverse">
                        ...
                        <li>
                            <a href="#contacto" className="scroll-smooth block py-2 px-3 text-custom-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 smoo">Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
